...
use App\Models\CoastEconomat;
use App\Models\Fiche;
use App\Models\Restaurant;
use Illuminate\Http\Request;
use Inertia\Inertia;

class CoastEconomatController extends Controller
{
    public function index()
    {
        $restaurants = Restaurant::all(['id', 'name', 'slug']);

        return Inertia::render('FluxReel/CoastEconomat/CoastEconomatRestau', [
    ...
    public function show(Request $request, $restaurantSlug)
    {
        ...
        $coastData = CoastEconomat::where('restaurant_id', $restaurant->id)
        ...
        return Inertia::render('FluxReel/CoastEconomat/CoastEconomat', [
