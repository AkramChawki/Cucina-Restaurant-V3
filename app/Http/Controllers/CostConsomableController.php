...
class CostConsomableController extends Controller
{
    public function index()
    {
        ...
        return Inertia::render('FluxReel/CostConsomable/CostConsomableRestau', [
    ...
    public function show(Request $request, $restaurantSlug)
    {
        ...
        $costData = CostConsomable::where('restaurant_id', $restaurant->id)
        ...
        return Inertia::render('FluxReel/CostConsomable/CostConsomable', [
