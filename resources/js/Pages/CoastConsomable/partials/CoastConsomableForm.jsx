...
export default function CoastConsomableForm({ restaurant, products, currentMonth }) {
    ...
    const handleValueChange = (productId, day, value) => {
        router.post(route('coast-consomable.update-value'), {
            ...
            <div className="bg-white rounded-lg shadow p-4 mb-6">
                <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
                    <div className="flex-1">
                        <h2 className="text-lg font-semibold text-gray-900">Coast Consomable</h2>
