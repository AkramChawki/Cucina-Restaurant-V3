...
export default function CostConsomableForm({ restaurant, products, currentMonth }) {
    ...
    const handleValueChange = (productId, day, value) => {
        router.post(route('cost-consomable.update-value'), {
            ...
            <div className="bg-white rounded-lg shadow p-4 mb-6">
                <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
                    <div className="flex-1">
                        <h2 className="text-lg font-semibold text-gray-900">Cost Consomable</h2>
